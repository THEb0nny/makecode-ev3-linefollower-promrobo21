...
let B_REF_RAW_LS1 = 2260; // Сырое значение на чёрном для левого датчика цвета
let W_REF_RAW_LS1 = 1560; // Сырое значение на белом для левого датчика цвета
let B_REF_RAW_LS2 = 2156; // Сырое значение на чёрном для левого датчика цвета
let W_REF_RAW_LS2 = 1560; // Сырое значение на белом для левого датчика цвета
let B_REF_RAW_LS3 = 2144; // Сырое значение на чёрном для правого датчика цвета
let W_REF_RAW_LS3 = 1516; // Сырое значение на белом для правого датчика цвета
let B_REF_RAW_LS4 = 2288; // Сырое значение на чёрном для левого датчика цвета
let W_REF_RAW_LS4 = 1564; // Сырое значение на белом для левого датчика цвета
...
function Main() { // Определение главной функции
    ...
    motions.lineFollow4SensorSpeed = 50;
    motions.lineFollow4SensorKp = 0.5;
    motions.lineFollow4SensorKd = 0;
    motions.lineFollow4SensorSideSensCoef = 4;
    ...
    // Ваш код тут
    motions.LineFollow4SensorWithLossProtection();
}
